...
const dictionaries: Record<Locale, Dictionary> = {
  de: {
    ...
    auth: {
      ...
      title: "An",
      accentTitle: "melden.",
      lede: "Bauhaus Forms | Workflow-System der Bauhaus-Universität Weimar.",
    ...
    forms: {
      ...
      reviseIntro: "Diese Einreichung ist für Änderungen geöffnet. Eine erneute Abgabe setzt den Workflow fort.",
    ...
    submissions: {
      ...
      submitterDescription: "Veröffentlichte Formulare starten, Entscheidungen verfolgen und Entwürfe oder Revisionen ohne Kontextverlust fortsetzen.",
      ...
      detailDescription: "Gemeinsame Fallakte für Einreichende, Freigebende, Administration und Compliance.",
    ...
    adminForms: {
      ...
      pageDescription: "Neue Intake-Erlebnisse erstellen, Workflows verknüpfen und Formulare per Builder von Entwurf auf veröffentlicht umstellen.",
    ...
    builder: {
      ...
      fieldAccessTipsA: "Verwenden Sie die Einstellungen unten, um Verschlüsselung und Rollenleserechte zu steuern.",
      ...
      builderCanvasHelp: "Komponenten in einen großzügigen Arbeitsbereich ziehen; Metadaten liegen oberhalb.",
