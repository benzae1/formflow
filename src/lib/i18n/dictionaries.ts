...
const dictionaries: Record<Locale, Dictionary> = {
  de: {
    common: {
      ...
      brandSubtitle: "Universitaetskommunikation",
      signedIn: "Angemeldet",
      back: "Zurueck",
      close: "Schliessen",
    ...
    auth: {
      ...
      title: "An",
      accentTitle: "melden.",
      lede: "Bauhaus Forms | Workflow-System der Bauhaus-Universitaet Weimar.",
      ...
      passwordPlaceholder: "........",
      submit: "Anmelden",
      submitPending: "Anmeldung laeuft...",
      error: "Benutzername oder Passwort ist ungueltig. Bitte erneut versuchen.",
      help: "Hilfe",
      imprint: "Impressum",
      privacy: "Datenschutz",
    ...
    forms: {
      formNotAvailable: "Formular ist nicht verfuegbar.",
      editSubmission: "Einreichung bearbeiten",
      publishedForm: "Veroeffentlichtes Formular",
      responseIntro: "Fuellen Sie das veroeffentlichte Formular aus, um den Workflow zu starten.",
      draftIntro: "Dieser Entwurf kann weiterbearbeitet und spaeter eingereicht werden.",
      reviseIntro: "Diese Einreichung ist fuer Aenderungen geoeffnet. Eine erneute Abgabe setzt den Workflow fort.",
      ...
      generateDraftTranslation: "Uebersetzungsentwurf erzeugen",
      translationUnavailable: "DeepL ist nicht konfiguriert. Manuelle Uebersetzung bleibt verfuegbar.",
      translationNeedsReview: "Automatisch erzeugte Uebersetzungen muessen vor der Veroeffentlichung geprueft werden.",
      german: "Deutsch",
      english: "Englisch",
      translationGenerated: "Uebersetzungsentwurf gespeichert.",
    },
    submissions: {
      notAvailable: "Nicht verfuegbar",
      restrictedOrEmpty: "Eingeschraenkt oder nicht angegeben",
      mySubmissions: "Meine Einreichungen",
      submitterWorkspace: "Arbeitsbereich fuer Einreichende",
      submitterDescription: "Veroeffentlichte Formulare starten, Entscheidungen verfolgen und Entwuerfe oder Revisionen ohne Kontextverlust fortsetzen.",
      submissionList: "Einreichungsliste",
      currentWork: "Aktuelle Arbeit",
      searchPlaceholder: "Nach Formulartitel suchen",
      allStatuses: "Alle Status",
      filter: "Filtern",
      noMatchesEyebrow: "Noch nichts hier",
      noMatchesTitle: "Keine Einreichungen fuer diese Ansicht",
      noMatchesDescription: "Versuchen Sie einen anderen Filter oder starten Sie rechts ein neues Formular.",
      publishedForms: "Veroeffentlichte Formulare",
      startSomethingNew: "Neu starten",
      nothingPublishedEyebrow: "Keine Formulare veroeffentlicht",
      nothingPublishedTitle: "Derzeit ist nichts offen",
      nothingPublishedDescription: "Bitten Sie eine Administratorin oder einen Administrator, ein Formular mit Workflow zu veroeffentlichen.",
      updated: "Aktualisiert",
      latestNote: "Letzte Notiz",
      resumeDraft: "Entwurf fortsetzen",
      startNew: "Neu beginnen",
      detailEyebrow: "Einreichungsdetail",
      detailDescription: "Gemeinsame Fallakte fuer Einreichende, Freigebende, Administration und Compliance.",
      formVersion: "Formularversion",
      submittedBy: "Eingereicht von",
      created: "Erstellt",
      responseSnapshot: "Antwort-Snapshot",
      submittedAnswers: "Eingereichte Antworten",
      followUpWork: "Folgeaufgaben",
      ...
      noWorkflowSummary: "Keine Workflow-Zusammenfassung verfuegbar.",
    },
    inbox: {
      coverageTitle: "Vertretung",
      coverageDescription: "Legen Sie eine Vertretung fest, damit neue Freigaben bei Abwesenheit sauber weitergeleitet werden.",
    },
    adminForms: {
      pageEyebrow: "Admin-Formulare",
      pageTitle: "Formularkatalog",
      pageDescription: "Neue Intake-Erlebnisse erstellen, Workflows verknuepfen und Formulare per Builder von Entwurf auf veroeffentlicht umstellen.",
      searchPlaceholder: "Nach Titel oder Slug suchen",
      createForm: "Formular erstellen",
      openBuilder: "Builder oeffnen",
      version: "Version",
      workflow: "Workflow",
      unassigned: "Nicht zugewiesen",
      newForm: "Neues Formular",
      freshShell: "Mit einer leeren Vorlage starten",
      formTitle: "Formulartitel",
      noWorkflowYet: "Noch kein Workflow",
      noParentForm: "Kein Elternformular",
      slugHelp: "Slugs verwenden Kleinbuchstaben, Zahlen und Bindestriche. Der Workflow kann spaeter hinzugefuegt werden.",
      createAndOpenBuilder: "Erstellen und Builder oeffnen",
      ...
      createError: "Das Formular konnte nicht erstellt werden. Bitte Slug oder Workflow-Auswahl pruefen.",
      defaultTitle: "Anfragetitel",
    ...
    builder: {
      ...
      metadataHelp: "Metadaten und Workflow-Zuordnung verwalten, bevor Sie in den Builder wechseln.",
      previewSchema: "Schema-JSON anzeigen",
      backToBuilder: "Zurueck zum Builder",
      sensitivity: "Sensitivitaet",
      noWorkflowAssigned: "Kein Workflow zugewiesen",
      fieldAccessTips: "Tipps zum Feldzugriff",
      fieldAccessTipsA: "Verwenden Sie die Einstellungen unten, um Verschluesselung und Rollenleserechte zu steuern.",
      fieldAccessTipsB: "Aenderungen an veroeffentlichten Formularen erzeugen automatisch neue Versionen.",
      fieldAccessSettings: "Feldzugriffseinstellungen",
      encryptField: "Feld verschluesselt speichern",
      readRoles: "Leserollen",
      submitterCanRead: "Einreichende duerfen ihren eigenen Wert lesen",
      builderCanvas: "Builder-Flaeche",
      builderCanvasHelp: "Komponenten in einen grosszuegigen Arbeitsbereich ziehen; Metadaten liegen oberhalb.",
      saveFailed: "Die Builder-Aenderungen konnten nicht gespeichert werden.",
      formPublished: "Formular veroeffentlicht.",
  ...
  en: {
    ...
    auth: {
      ...
      title: "Sign",
      accentTitle: "in.",
      lede: "Bauhaus Forms | Workflow system of the Bauhaus-Universitaet Weimar.",
